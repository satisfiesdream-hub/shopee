...
const products = [
  ...
  { id:21, name:'Mascara Volume', brand:'Noir', category:'cosmetic', price:9, original:null, img:'https://images.unsplash.com/photo-1631214524020-3c69b3b0e5e7?w=400&q=80', rating:4.3, reviews:267, badge:'new' },
  { id:22, name:'Foundation Stick', brand:'Rouge', category:'cosmetic', price:18, original:25, img:'https://images.unsplash.com/photo-1596462502278-27bfdc403348?w=400&q=80', rating:4.5, reviews:341, badge:'sale' },
  ...
  { id:25, name:'Oxidised Bangles Set', brand:'Éclat', category:'jewellery', price:8, original:null, img:'https://images.unsplash.com/photo-1611591437281-460bfbe1220a?w=400&q=80', rating:4.2, reviews:143, badge:'new' },
  { id:26, name:'Kundan Maang Tikka', brand:'Éclat', category:'jewellery', price:15, original:22, img:'https://images.unsplash.com/photo-1535632066927-ab7c9ab60908?w=400&q=80', rating:4.7, reviews:98, badge:'sale' },
  { id:27, name:'Rose Gold Ring', brand:'Éclat', category:'jewellery', price:35, original:50, img:'https://images.unsplash.com/photo-1605100804763-247f67b3557e?w=400&q=80', rating:4.8, reviews:211, badge:'sale' },
  ...
  { id:28, name:'Rose Body Mist', brand:'Sillage', category:'fragrance', price:5, original:8, img:'https://images.unsplash.com/photo-1592945403244-b3fbafd7f539?w=400&q=80', rating:4.3, reviews:412, badge:'sale' },
  { id:29, name:'Lavender Deodorant', brand:'Sillage', category:'fragrance', price:4, original:null, img:'https://images.unsplash.com/photo-1541643600914-78b084683702?w=400&q=80', rating:4.2, reviews:298, badge:'new' },
  { id:30, name:'Jasmine Attar', brand:'Sillage', category:'fragrance', price:7, original:10, img:'https://images.unsplash.com/photo-1523293182086-7651a899d37f?w=400&q=80', rating:4.5, reviews:187, badge:'sale' },
  { id:31, name:'Sandalwood Perfume Oil', brand:'Sillage', category:'fragrance', price:11, original:null, img:'https://images.unsplash.com/photo-1541643600914-78b084683702?w=400&q=80', rating:4.6, reviews:143, badge:'new' },
  { id:32, name:'Citrus Splash EDT', brand:'Sillage', category:'fragrance', price:22, original:30, img:'https://images.unsplash.com/photo-1592945403244-b3fbafd7f539?w=400&q=80', rating:4.4, reviews:176, badge:'sale' },
];
